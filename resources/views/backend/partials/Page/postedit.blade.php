...
<form action="{{'companypost.edit',$companypost->id}}" method="post" enctype="multipart/form-data">
 @csrf 
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input name="role" type="text" class="form-control" id="company_address"  placeholder="Enter your role">
